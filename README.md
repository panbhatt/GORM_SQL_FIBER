...
- Create a database notes-api in your SQL Server local instance
- Rename `.env.exmaple` to `.env`.
- Add in the database user and password for your SQL Server instance containing the database fiber-app.
